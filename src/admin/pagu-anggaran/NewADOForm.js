        ...
        <Modal show onHide={() => this.props.hide()}>
          ...
          <Modal.Body>
            ...
            <Form.Group controlId="formADOName">
              ...
              <Form.Control type="text" required value={this.props.name} onChange={this.props.onChangeName} />
            </Form.Group>
            <Form.Group controlId="formADODetail">
              <Form.Label column sm="2">Detail</Form.Label>
              <Form.Control type="text" required value={this.props.detail} onChange={this.props.onChangeDetail} />
            </Form.Group>
            </Form>
