...
class InputUnitADO extends Component {
  ...
  getRKA = (e) => {
    ...
    const unit = node[0].value,
      subunit = node[1].value,
      ADO = node[2].value;
      ...
      <>
        ...
        <form className="form-group" ref={this.userInput}>
          ...
          <select className="form-select form-select-sm" id="select-subunit">
            {data.subunits.map((subunit, ID) => (
              <option key={ID} value={subunit}>
                {subunit}
              </option>
            ))}
          </select>
          ...
          <select className="form-select form-select-sm" id="select-ADO">
            {data.ADOs.map((ADO, ID) => (
              <option key={ID} value={ADO}>
                {ADO}
              </option>
            ))}
          </select>{" "}
          <br />
          <button className="btn btn-primary mt-2" onClick={this.getRKA}>
            Lihat RKA
          </button>
        </form>
      </>
