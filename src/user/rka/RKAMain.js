...
export class RKAMain extends Component {
  ...
  handleADOChange = (e) => {
    ...
    if (ado === "ALL") {
      ...
      PaguDataService.getAlokasiPagu(
        unit,
        subunit,
        ado,
      ...
      PaguDataService.getPenggunaanPagu(
        unit,
        subunit,
        ado,
        new Date().getFullYear()
          ...
          <div className="col-1.75">
            <form className="form-group">
              ...
              <select
                ...
                id="select-ADO"
                name="ado"
                onChange={this.handleADOChange}
                ref={this.currentADO}
              >
                <option value="ALL">All</option>
                {this.state.ADO.map((ADO) => (
          ...
          <div className="col-10 mt-2">
            <span className="mb-4 font-weight-bold">
              ...
              <span className="font-weight-normal">
                {" "}
                {formatRupiah(alokasi)}{" "}
              </span>{" "}
              <br />
            </span>

            <span className="mb-4 font-weight-bold">
              Penggunaan Anggaran {ado === "ALL" ? "Total" : ado} sampai hari
              ini:
              <span className="font-weight-normal">
                {" "}
                {formatRupiah(penggunaan)}{" "}
              </span>{" "}
              <br />
            </span>
            ...
            <span className="mb-4 font-weight-bold">
              ...
              <span className="font-weight-normal"> {formatRupiah(sisa)} </span>{" "}
              <br />
            </span>
